...
-- ==========================================
-- Ve todo y gestiona todo (inventario, usuarios, asignaciones)
...
-- ==========================================
-- Ve todas las mascotas, dueños y puede agendar citas
...
-- Restricción estricta: NO puede ver vacunas aplicadas
...
-- Puede registrar citas y aplicar vacunas
